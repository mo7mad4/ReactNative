...
function App() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Start 
      {TouchableOpacity} => 
      Lightens the opacity of the entire element when pressed, the default activeOpacity to 0.2.
      */}
      ...
      {/* Start 
      {TouchableHighlight} => 
      Darkens the background of the element when pressed, the default activeOpacity to 0.85.
      */}
      <TouchableHighlight style={styles.button} onPress={onPress}>
        <Text>Press Here</Text>
      </TouchableHighlight>
      {/* End {TouchableHighlight} */}

      {/*Start 
      {TouchableWithoutFeedback} =>
      Element have not a visual feedback when touched.
        */}
      <TouchableWithoutFeedback style={styles.button} onPress={onPress}>
        <Text>Press Here</Text>
      </TouchableWithoutFeedback>
      {/* End {TouchableWithoutFeedback} */}
    </View>
  );
}
